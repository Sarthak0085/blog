...
export const ShareModal = ({ children, blogUrl, open, setOpen }: ShareModalProps) => {
    const twitterShareUrl = `https://www.twitter.com/intent/tweet?url=${encodeURIComponent(blogUrl)}&text=Check out this blog post!`;
    const facebookShareUrl = `https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(blogUrl)}`;
    const linkedInShareUrl = `https://www.linkedin.com/shareArticle?mini=true&url=${encodeURIComponent(blogUrl)}`;
    const instagramShareUrl = `https://www.instagram.com/?url=${encodeURIComponent(blogUrl)}`;
    const pinterestShareUrl = `https://pinterest.com/pin/create/button/?url=${encodeURIComponent(blogUrl)}&media=&description=Check out this blog post!`;
    const redditShareUrl = `https://www.reddit.com/submit?url=${encodeURIComponent(blogUrl)}&title=Check out this blog post!`;
    const whatsappShareUrl = `https://api.whatsapp.com/send?text=${encodeURIComponent(blogUrl)}`;
    const emailShareUrl = `mailto:?subject=Check out this blog post!&body=${encodeURIComponent(blogUrl)}`;

    const [isHovered, setIsHovered] = useState<{ [key: string]: boolean }>({});

    const handleMouseEnter = (name: string) => {
        setIsHovered((prev) => ({ ...prev, [name]: true }));
    }
    const handleMouseLeave = (name: string) => {
        setIsHovered((prev) => ({ ...prev, [name]: false }));
    }
        ...
        <Dialog defaultOpen={open}>
            ...
            <DialogContent >
                ...
                <div className="flex flex-wrap items-start gap-2">
                    <Button
                        variant={isHovered["facebook"] ? "primary" : "ghost"}
                        className="gap-2"
                    ...
                    <Button
                        variant={isHovered["twitter"] ? "primary" : "ghost"}
                        className="gap-2"
                    ...
                    <Button
                        variant={isHovered["whatsapp"] ? "primary" : "ghost"}
                    ...
                    <Button
                        variant={isHovered["linkedin"] ? "primary" : "ghost"}
                        className="gap-2"
                    ...
                    <Button
                        variant={isHovered["instagram"] ? "primary" : "ghost"}
                        className="gap-2"
                    ...
                    <Button
                        variant={isHovered["pininterest"] ? "primary" : "ghost"}
                        className="gap-2"
                        onMouseEnter={() => handleMouseEnter("pininterest")}
                        onMouseLeave={() => handleMouseLeave("pininterest")}
                    ...
                    >
                        ...
                        <span>Pin Interest</span>
                    </Button>
                    <Button
                        variant={isHovered["reddit"] ? "primary" : "ghost"}
                        className="gap-2"
                        onMouseEnter={() => handleMouseEnter("reddit")}
                        onMouseLeave={() => handleMouseLeave("reddit")}
                    ...
                    <Button
                        variant={isHovered["email"] ? "primary" : "ghost"}
                        className="gap-3"
                    ...
                    <Button
                        variant={isHovered["copylink"] ? "primary" : "ghost"}
                        className="gap-3"
                        onMouseEnter={() => handleMouseEnter("copylink")}
                        onMouseLeave={() => handleMouseLeave("copylink")}
